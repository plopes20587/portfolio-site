...
const ProjectNavigation = ({ previousProject, nextProject }: Props) => {
  return (
    <section className="border-t border-white/10 bg-ink-900/50 px-6 py-16 md:px-[60px]">
      <div className="mx-auto flex max-w-[1100px] flex-row">
          ...
          {previousProject ? (
            ...
            >
              <div className="flex items-center gap-2 text-white/50">
                <ArrowLeftIcon />
                <span className="font-body text-[14px] uppercase tracking-wider">Previous</span>
              </div>
          ...
          {nextProject ? (
            ...
            >
              <div className="flex items-center justify-end gap-2 text-white/50">
                <span className="font-body text-[14px] uppercase tracking-wider">Next</span>
                <ArrowRightIcon />
              </div>
              <h3 className="font-display text-[24px] text-white transition group-hover:text-primary">
                {nextProject.title}
