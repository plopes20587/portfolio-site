...
const CaseStudyHero = ({ study }: CaseStudyHeroProps) => {
  ...
  return (
    <section className="relative z-0 min-h-[600px] overflow-hidden bg-ink px-24 pb-80 pt-32 md:px-60 md:pt-100">
      ...
      <div className="relative z-0 mx-auto grid max-w-[1320px] gap-12 lg:grid-cols-2 lg:items-center">
        ...
        <div
          className="order-1 flex w-full flex-col gap-8 rounded-16 border p-24 lg:order-1"
          style={{
        ...
        <div className="relative order-2 flex items-center justify-center lg:order-2 max-h-[650px] w-fit h-fit">
          {heroImage ? (
            <img
              src={heroImage}
